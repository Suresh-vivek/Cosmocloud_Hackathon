          ...
          <div className="cards-wrapper1">
            <div className="service_card">
              ...
              <div className="sdesc">
                ...
                scrapes data from all sublinks. Using advanced lagchain models,
                it organizes and analyzes information for quick retrieval.
                Perfect for onboarding, Kitabi Keeda allows users to ask
                questions and get accurate answers from the documentation,
            ...
            <div className="service_card">
              ...
              <div className="sdesc">
                This as the name suggest is your code teacher , friend , or
                interviewer.Yeah Interviewer !!! Sounds Amazing , Why not try it
                out then.
              </div>
            ...
            <div className="service_card">
              ...
              <div className="sdesc">
                This is for students from our team so they can learn in every
                minute by detailed analysis of everything they see , say or
                answer 💣
              </div>
              <div className="sbutton">
                <button className="btn">Try Now</button>
